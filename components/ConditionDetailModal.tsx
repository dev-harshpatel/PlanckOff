...
import { X, Hash, Ruler, Grid } from 'lucide-react';
...
export const ConditionDetailModal: React.FC<ConditionDetailModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm pt-4 pb-4 px-4 overflow-hidden font-sans">
            <div className="bg-slate-100 rounded shadow-2xl w-full h-full max-w-[95vw] flex flex-col overflow-hidden border border-slate-400">
                ...
                <div className="bg-[#f0f0f0] border-b border-slate-300 p-2 flex gap-4 shrink-0 text-xs">
                    ...
                    <div className="w-32 flex flex-col justify-end">
                        <button onClick={onClose} className="bg-slate-200 border border-slate-400 px-3 py-1 text-sm font-bold hover:bg-slate-300 rounded mb-1">Close</button>
                    </div>
                </div>
