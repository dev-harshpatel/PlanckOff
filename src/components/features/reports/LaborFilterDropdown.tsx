...
interface LaborFilterDropdownProps {
  availableItems: string[];
  availableLevels: string[];
  availableCostCodes: string[];
  filterState: LaborFilterState;
  onFilterChange: (state: LaborFilterState) => void;
}

export const LaborFilterDropdown = ({
  availableItems,
  availableLevels,
  availableCostCodes,
  filterState,
  onFilterChange,
}: LaborFilterDropdownProps) => {
  ...
  const updateFilter = useCallback(
    (key: keyof LaborFilterState, value: Set<string>) => {
      ...
      >
        <ModalBody className="max-h-[75vh] overflow-y-auto">
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Row 2: Labor Items — full width, taller list */}
            <FilterSection
              title="Labor Items"
